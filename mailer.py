...
class Message(object):
    ...
    def _plaintext(self):
        ...
        if not self.Html:
            msg = MIMEText(str(self.Body), 'plain', self.charset)
        else:
            msg = self._with_html()
    ...
    def _with_html(self):
        ...
        part1 = MIMEText(str(self.Body), 'plain', self.charset)
    ...
    def _set_info(self, msg):
        ...
        if self.Headers:
            for key, value in list(self.Headers.items()):
                msg[key] = str(str(value).encode(self.charset))
    ...
    def _multipart(self):
        ...
        if self.Html:
            ...
            msg.attach(MIMEText(str(self.Body), 'plain', self.charset))
